 ...
 * 
 */
@WebServiceClient(name = "WSCuenta", targetNamespace = "http://ws.monster.edu.ec/", wsdlLocation = "http://localhost:8080/eurekabank_soap_java_gr06/WSCuenta?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/eurekabank_soap_java_gr06/WSCuenta?wsdl");
