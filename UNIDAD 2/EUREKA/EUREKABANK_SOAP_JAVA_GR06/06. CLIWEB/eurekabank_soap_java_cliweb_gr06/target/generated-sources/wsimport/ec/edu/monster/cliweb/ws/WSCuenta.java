...
public interface WSCuenta {
     ...
     * @param cuenta
     * @return
     *     returns ec.edu.monster.cliweb.ws.Resultado
     */
    @WebMethod
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "depositar", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.Depositar")
    @ResponseWrapper(localName = "depositarResponse", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.DepositarResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "retirar", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.Retirar")
    @ResponseWrapper(localName = "retirarResponse", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.RetirarResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "transferir", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.Transferir")
    @ResponseWrapper(localName = "transferirResponse", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.cliweb.ws.TransferirResponse")
     ...
     * @param cliente
     * @return
     *     returns java.util.List<ec.edu.monster.cliweb.ws.CuentaResumen>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
     ...
     * 
     * @return
     *     returns java.util.List<ec.edu.monster.cliweb.ws.ClienteResumen>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
