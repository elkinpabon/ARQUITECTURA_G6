...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(TicketController ctrl, Runnable onOk) {
        ...
        wrapper.setBackground(Estilo.FONDO);
    ...
    private JPanel construirForm(TicketController ctrl, Runnable onOk) {
        ...
        form.setBackground(Estilo.SUPERFICIE);
        form.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(Estilo.BORDE),
                BorderFactory.createEmptyBorder(18, 22, 18, 22)));
        form.setPreferredSize(new Dimension(FORM_PREF_W, 500));
        form.setMinimumSize(new Dimension(FORM_MIN_W, 440));
        ...
        JLabel titulo = new JLabel("TicketPremium FIFA 2026", SwingConstants.CENTER);
        titulo.setFont(Estilo.fuente(Font.BOLD, 24));
        titulo.setForeground(Estilo.AZUL);
        g.gridy = 1;
        form.add(titulo, g);

        JLabel sub = new JLabel("Iniciar sesion - GR06", SwingConstants.CENTER);
        sub.setFont(Estilo.fuente(Font.PLAIN, 13));
        sub.setForeground(Estilo.TEXTO_SUAVE);
        g.gridy = 2;
        form.add(sub, g);
        ...
        // Boton
        JButton btn = Estilo.botonPrimario("Iniciar sesion");
