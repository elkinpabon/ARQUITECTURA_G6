...
/** Una linea del carrito de compra del cliente consola (un asiento reservado). */
public class LineaCarrito {
    ...
    public LineaCarrito(int codigoPartido, String partidoDesc, int idSeccion, String seccionLabel,
