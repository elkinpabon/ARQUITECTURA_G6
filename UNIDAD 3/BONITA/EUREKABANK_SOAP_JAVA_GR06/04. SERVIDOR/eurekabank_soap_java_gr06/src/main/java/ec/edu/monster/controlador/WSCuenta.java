...
public class WSCuenta {
    ...
    /** Punto de auditoria consumido por el proceso BPM Bonita. */
    ...
    public Resultado registrarAuditoriaBPM(
        ...
        try {
            new AuditoriaBpmDAO().registrar(
                    operacion, cuentaOrigen, cuentaDestino, monto, usuario, estado);
            LOG.info(() -> "AUDITORIA BPM guardada | operacion=" + operacion
            ...
            LOG.log(java.util.logging.Level.SEVERE, "No se pudo registrar la auditoria BPM", e);
