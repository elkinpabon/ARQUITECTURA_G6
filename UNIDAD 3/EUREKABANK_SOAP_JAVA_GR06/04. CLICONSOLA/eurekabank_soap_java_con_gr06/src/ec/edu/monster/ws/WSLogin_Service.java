 ...
 * 
 */
@WebServiceClient(name = "WSLogin", targetNamespace = "http://ws.monster.edu.ec/", wsdlLocation = "http://localhost:8080/eurekabank_soap_java_gr06/WSLogin?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/eurekabank_soap_java_gr06/WSLogin?wsdl");
