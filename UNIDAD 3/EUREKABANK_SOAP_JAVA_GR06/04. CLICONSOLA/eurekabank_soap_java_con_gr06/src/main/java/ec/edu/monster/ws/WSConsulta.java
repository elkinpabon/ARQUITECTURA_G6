...
public interface WSConsulta {
    ...
    Resultado registrarCliente(@WebParam(name = "paterno", targetNamespace = "") String paterno,
            @WebParam(name = "materno", targetNamespace = "") String materno,
            @WebParam(name = "nombre", targetNamespace = "") String nombre,
            @WebParam(name = "dni", targetNamespace = "") String dni,
            @WebParam(name = "ciudad", targetNamespace = "") String ciudad,
            @WebParam(name = "direccion", targetNamespace = "") String direccion,
            @WebParam(name = "telefono", targetNamespace = "") String telefono,
    ...
    Resultado registrarCuenta(@WebParam(name = "cliente", targetNamespace = "") String cliente,
