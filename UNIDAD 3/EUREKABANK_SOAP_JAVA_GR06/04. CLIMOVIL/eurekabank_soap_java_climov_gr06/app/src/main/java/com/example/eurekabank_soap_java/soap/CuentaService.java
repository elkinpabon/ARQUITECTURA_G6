...
/** WSCuenta vía ksoap2 con enrutamiento dinámico a los 5 microservicios. */
public class CuentaService {
    ...
    public List<CuentaResumen> listarCuentasPorCliente(String criterio) throws Exception {
        Object body = SoapBase.llamar(ServidorConfig.endpointConsulta(),
    ...
    public Resultado consultarSaldo(String cuenta) throws Exception {
        return parseResultado(SoapBase.llamar(ServidorConfig.endpointConsulta(),
    ...
    public Resultado depositar(String cuenta, String monto, String moneda) throws Exception {
        return parseResultado(SoapBase.llamar(ServidorConfig.endpointDeposito(),
    ...
    public Resultado retirar(String cuenta, String monto, String moneda) throws Exception {
        return parseResultado(SoapBase.llamar(ServidorConfig.endpointRetiro(),
    ...
    public Resultado transferir(String origen, String destino, String monto,
        ...
        return parseResultado(SoapBase.llamar(ServidorConfig.endpointTransferencia(),
