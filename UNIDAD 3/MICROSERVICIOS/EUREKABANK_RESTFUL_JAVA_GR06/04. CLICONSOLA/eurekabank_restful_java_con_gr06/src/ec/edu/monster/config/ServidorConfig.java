...
/**
 * Bases de los microservicios REST.
 * La prioridad por clave es propiedad de sistema, variable de entorno en
 * mayúsculas y, finalmente, /microservices.properties empaquetado.
 */
