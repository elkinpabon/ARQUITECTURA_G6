...
public final class Rest {
    ...
    public static String getText(String servicio, String path) {
        return enviar(HttpRequest.newBuilder(URI.create(url(servicio, path))).GET().build());
    }
    ...
    public static JsonArray getArray(String servicio, String path) {
        JsonStructure s = parse(getText(servicio, path));
        return s == null ? Json.createArrayBuilder().build() : (JsonArray) s;
    }

    public static JsonObject post(String servicio, String path, String body) {
