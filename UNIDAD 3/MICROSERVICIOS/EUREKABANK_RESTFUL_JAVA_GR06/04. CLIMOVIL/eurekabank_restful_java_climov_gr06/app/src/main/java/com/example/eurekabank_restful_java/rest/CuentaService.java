...
public class CuentaService {
    ...
    public List<CuentaResumen> listarCuentasPorCliente(String criterio) throws Exception {
        JSONArray a = new JSONArray(
                Http.get(ServidorConfig.BASE_CONSULTA,
                        "/cuentas?cliente=" + Http.enc(criterio)));
    ...
    public List<ClienteResumen> listarClientes() throws Exception {
        JSONArray a = new JSONArray(Http.get(ServidorConfig.BASE_CONSULTA, "/clientes"));
    ...
    public Resultado consultarSaldo(String cuenta) throws Exception {
        return toResultado(Http.get(ServidorConfig.BASE_CONSULTA,
                "/cuentas/" + Http.enc(cuenta) + "/saldo"));
    }
    ...
    public Resultado depositar(String cuenta, String monto, String moneda) throws Exception {
        return toResultado(Http.post(ServidorConfig.BASE_TRANSACCIONES,
    ...
    public Resultado registrarCliente(String paterno, String materno, String nombre,
        ...
        return toResultado(Http.post(ServidorConfig.BASE_CONSULTA, "/clientes", b.toString()));
    }
    ...
    public Resultado registrarCuenta(String cliente, String moneda) throws Exception {
        ...
        return toResultado(Http.post(ServidorConfig.BASE_CONSULTA, "/cuentas", b.toString()));
    }

    public Resultado eliminarCuenta(String cuenta) throws Exception {
        return toResultado(Http.delete(ServidorConfig.BASE_CONSULTA,
                "/cuentas/" + Http.enc(cuenta)));
    }
