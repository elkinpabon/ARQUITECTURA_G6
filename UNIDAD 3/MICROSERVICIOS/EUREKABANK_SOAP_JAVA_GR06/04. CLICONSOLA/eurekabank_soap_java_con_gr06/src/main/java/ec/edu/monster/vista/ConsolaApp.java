...
public class ConsolaApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Autenticacion: " + MicroserviciosConfig.epLogin());
        while (true) {
    ...
    private static String pedirMoneda() {
        System.out.println("Moneda del monto: 1) Dolares (preferente)  2) Soles");
        String s = pedir("Opcion [1]");
    ...
    private static void buscarCliente() {
        ...
        String cod = pedir("Codigo de cliente");
    ...
    private static void operarMenu() {
        ...
        try {
            ...
            System.out.println(">> Operacion completada; no se pudieron refrescar las cuentas: " + e.getMessage());
        }
    }
    ...
    private static void verMovimientos(String cuenta) {
        ...
        for (MovimientoModel m : ms) {
            ...
            if (m.getMonedaOrigen() != null && !m.getMonedaOrigen().isBlank()) {
                System.out.printf("      [conversion] %,.2f %s  x tasa %s  =  %,.2f%n",
                        m.getImporteOrigen() == null ? 0 : m.getImporteOrigen(),
                        Moneda.nombre(m.getMonedaOrigen()),
                        m.getTasaAplicada(), imp);
            }
        }
        System.out.printf("TOTALES  Creditos: %,.2f   Debitos: %,.2f   Neto: %,.2f%n",
                tin, tout, tin - tout);
        ...
        if ("S".equalsIgnoreCase(pedir(
            ...
            try {
                ...
                System.out.println(">> Abrelo en el navegador y usa "
    ...
    private static void registrarCliente() {
        ...
        Resultado r = ctrl.registrarCliente(
                ...
                pedir("Direccion"), pedir("Telefono"), pedir("Email"));
        msg(r);
    }
    ...
    private static void registrarCuenta() {
        ...
        String cli = pedir("Codigo de cliente"
                + (sugerido != null ? " [Enter = " + sugerido + "]" : ""));
        if (cli.isEmpty() && sugerido != null) cli = sugerido;
        System.out.println("Moneda: 1) Dolares  2) Soles");
        String mon = "2".equals(pedir("Opcion [1]")) ? "01" : "02";
    ...
    private static void eliminarCuenta() {
        ...
        if (ct != null && !ct.isEmpty()) {
            ...
            String sel = pedir("Numero de la cuenta a eliminar (o codigo)");
            try {
            ...
            cta = pedir("Codigo de cuenta a eliminar");
        }
