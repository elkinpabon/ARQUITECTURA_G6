...
final class SoapClientProxy implements InvocationHandler {
    ...
    private static String marshal(Class<?> requestType, Object wrapper, String operation) throws Exception {
    ...
    private static Object readResponse(HttpResponse<String> response, Class<?> responseType) throws Exception {
        Document document;
        try {
        ...
        try { return responseType.getMethod("getReturn").invoke(wrapper); }
        catch (NoSuchMethodException e) { return responseType.getMethod("isReturn").invoke(wrapper); }
    }
