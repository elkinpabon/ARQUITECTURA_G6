...
public interface WSRetiro {
    @WebMethod @WebResult(targetNamespace = "") @RequestWrapper(localName = "retirar", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.ws.Retirar") @ResponseWrapper(localName = "retirarResponse", targetNamespace = "http://ws.monster.edu.ec/", className = "ec.edu.monster.ws.RetirarResponse")
